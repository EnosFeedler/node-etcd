...
(function() {
  ...
  Etcd = (function() {
    ...
    Etcd.prototype.setCustom = function(key, value, extraopts, callback) {
      ...
      return request.post(opt, function(err, resp, body) {
        if (!err && resp.statusCode === 307) {
          opt.url = resp.headers.location;
          return request.post(opt, _this._responseHandler(callback));
        } else {
          return (_this._responseHandler(callback))(err, resp, body);
        }
      });
    };
